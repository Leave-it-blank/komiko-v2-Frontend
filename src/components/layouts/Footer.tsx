    ...
    <>
      <div className="absolute    w-4/5 ml-20  bg-transparent  ">
        <div className="container mx-auto px-4  relative ">
          <span className=" fixed pointer-events-none select-none capitalize top-0 right-5 text-black dark:text-gray-200 dark:hover:text-gray-400   font-semibold py-1 text-xs">
