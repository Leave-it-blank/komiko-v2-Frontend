          ...
          <div className="flex flex-row rounded-md w-full">
            ...
            <div className="justify-end   px-3  w-full relative">
              <div className="flex flex-col font-roboto py-4 px-4 md:px-1 text-zinc-600  text-sm  w-full  ">
                ...
                >
                  <div className=" shrink-1 py-1 opacity-80 text-sm md:text-sm font-semibold mt-2 font-roboto capitalize  text-sky-400 text-center select-none cursor-pointer line-clamp-2     border-sky-700  border-2 bg-black rounded-md w-fit px-3">
